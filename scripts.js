...
/* Tried to get our scroll function to work for our second state 'sweet' with a boolean
but kept running into troubles showing different content on the same scroll
position for the show function. Essentially the placement should have been the 
same with different text for the 'cookie pizza' that corresponded to the images
and followed the same image building pattern as the 'savoury' pizza side*/
	else if(blue==true){
